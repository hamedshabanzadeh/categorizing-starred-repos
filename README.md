...
<!-- CATALOG_STATS_START -->
(به‌زودی پس از اولین اجرا این بخش به‌صورت خودکار پر می‌شود)
<!-- CATALOG_STATS_END -->

👉 See the full categorized list in [`CATALOG.md`](./CATALOG.md).
...
**Why no AI API key is needed / چرا نیازی به API key هوش مصنوعی نیست:**
